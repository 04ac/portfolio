const sampleThemes = [
  ...
  },
  {
    ...
    theme: {
      ...
      "--color-accent": "#78A9D6",
      "--color-accent-hover": "#5B8DBB",
      "--color-text": "#E0E9F1",
      "--color-onAccent": "#0A1525",
  ...
  //     "--color-text": "#ffffff",
  //     "--font-heading": "'JetBrains Mono'", // Perfect for code, has ligatures
  //     "--font-body": "'Ubuntu Mono'", // Friendly but technical
  //   },
  // },
  // {
  //   name: "Dracula",
  ...
  //     "--color-accent": "#bd93f9",
  //     "--color-accent-hover": "#bb80ff",
  //     "--color-onAccent": "#f8f8f2",
  //     "--color-text": "#f8f8f2",
  //     "--font-heading": "Nosifer",
  //     "--font-body": "VT323",
  //   },
  // },
  // {
